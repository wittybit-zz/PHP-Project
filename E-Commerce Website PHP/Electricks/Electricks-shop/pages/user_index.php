    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="user_index.php" class="navbar-brand" rel="tooltip" title="Designed for PHP" data-placement="bottom" target="">
                    E-Commerce Website
                </a>
            ...
            <div class="container">
                <nav>
                    <ul>
						...
						<li>Brought To You By <a href="https://php.com/">php</a> | Thanks to me </li>
                    </ul>
                </nav>
                <div class="copyright">
                    &copy;
